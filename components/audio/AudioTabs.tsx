    ...
    return (
      <div className={cn('flex items-center gap-2', className)}>
        <button
          ...
          disabled={isLoading}
          className="flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-6 py-3 font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50"
    ...
    <div className={cn('w-full', className)}>
      <Tabs defaultValue="original" className="w-full">
        ...
        <TabsContent value="original" className="space-y-2">
          <p className="text-sm text-muted-foreground">Listen to the original voice recording</p>
          <button
            onClick={() => handlePlayClick(originalAudioUrl!, 'original')}
        ...
        <TabsContent value="ai" className="space-y-2">
          <p className="text-sm text-muted-foreground">Listen to the AI-generated narration</p>
          <button
            onClick={() => handlePlayClick(aiAudioUrl!, 'ai')}
            disabled={aiState.isLoading}
            className="flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 px-6 py-3 font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50"
