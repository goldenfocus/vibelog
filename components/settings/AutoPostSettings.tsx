    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Automatically share your vibelogs on Twitter when you publish them
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Automatically post to Twitter when you publish a vibelog
          </p>
        </div>
        <button
          id="auto-post-toggle"
      ...
      <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-900/20">
        <p className="text-sm text-yellow-900 dark:text-yellow-300">
          <strong>Note:</strong> Twitter credentials must be configured in your environment
          variables. Contact your administrator if auto-posting is not working.
        </p>
      </div>
    </div>
  );
