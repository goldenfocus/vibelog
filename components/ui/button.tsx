...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 touch-manipulation active:scale-[0.98]',
  {
    variants: {
      ...
      size: {
        // Mobile-first sizes (48px minimum touch target)
        default: 'h-12 px-4 py-2', // 48px - was 40px
        sm: 'h-10 rounded-md px-3', // 40px - use sparingly, below minimum
        lg: 'h-14 rounded-md px-8', // 56px - comfortable for primary actions
        icon: 'h-12 w-12', // 48px - was 40px
        heroic: 'h-60 w-60', // 240px - for mic button and critical actions
      },
    },
    defaultVariants: {
      variant: 'default',
