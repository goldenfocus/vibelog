...
describe('Controls Component', () => {
  ...
  describe('State-dependent rendering', () => {
    it('renders idle state correctly', () => {
      render(<Controls recordingState="idle" recordingTime={0} {...mockHandlers} />);
    ...
    it('renders processing state with spinner', () => {
      render(<Controls recordingState="processing" recordingTime={30} {...mockHandlers} />);
    ...
    it('renders complete state', () => {
      render(<Controls recordingState="complete" recordingTime={30} {...mockHandlers} />);
  ...
  describe('Time formatting and limits', () => {
    it('formats time correctly', () => {
      render(<Controls recordingState="recording" recordingTime={0} {...mockHandlers} />);
  ...
  describe('User interactions', () => {
    ...
    it('calls onStopRecording when recording button is clicked', () => {
      render(<Controls recordingState="recording" recordingTime={30} {...mockHandlers} />);
    ...
    it('does not call handlers when disabled', () => {
      render(
        <Controls recordingState="idle" recordingTime={0} disabled={true} {...mockHandlers} />
      );
  ...
  describe('Accessibility', () => {
    it('has proper aria-label for each state', () => {
      ...
      states.forEach(state => {
        const { unmount } = render(
          <Controls recordingState={state} recordingTime={0} {...mockHandlers} />
        );
    ...
    it('has proper disabled state styling', () => {
      render(<Controls recordingState="processing" recordingTime={0} {...mockHandlers} />);
  ...
  describe('CSS classes and styling', () => {
    ...
    it('applies complete state styling', () => {
      render(<Controls recordingState="complete" recordingTime={0} {...mockHandlers} />);
