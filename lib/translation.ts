 ...
 *
 * Whisper API returns full language names (e.g., "english", "french") in verbose_json
 * response, but the database constraint requires ISO 639-1 codes (e.g., "en", "fr").
 *
 * This covers the 99 languages Whisper supports.
 */
